...
//    The constructor initializes a cross-hair texture used for aiming. In the DrawHUD function, the cross-hair is drawn at
//    the center of the screen using the cross-hair texture.
...
//    The created widget instance is then added to the view port, ensuring it is visible to players during game-play.
...
//    events, such as game-play state changes, player actions, or object interactions.
...
// On Begin, Create Widget and add to View-port
